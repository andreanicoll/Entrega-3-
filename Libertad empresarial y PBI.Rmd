...
str(gdp)
# notese que la data gdp contiene a todos los países, pero en un futuro, cuando se realice el  merging con las otras variables independientes de cada región (Europa y África), el key "Pais" solo tomará a los países según la región solicitada.
